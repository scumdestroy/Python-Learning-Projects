...
parser = argparse.ArgumentParser(
	...
	parser.add_argument('-msg', type=str, default="Stand behind your choices or lick the heels of fate eternal",
	help='Your call to those willing to connect')
...
while True:
    conn, addr = s.accept()
print('Now Connected to str(addr)')
s.recv(1024)
s.send(str(args.msg))

time.sleep(args.ttl)

if int(time.time()) > args.ttl:
